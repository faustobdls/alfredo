...
- [ ] **3.2. Visualizador Terminal Rich Text (TUI / Board):**
  - Adicionar modo interativo na CLI (`alfredo task board`) renderizando o estado atual de `READY`, `IN_PROGRESS` e `VERIFY` diretamente no terminal.
